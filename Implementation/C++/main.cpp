...
{
    cout << "hexadecimal => " << pt << endl;
    cout << "to"<< endl;
    cout << "binary => " << hex2bin(pt) << endl;
	cout <<"\n"<< endl;
	pt = hex2bin(pt);
	...
	cout << endl;
	cout << "Round " << "n" << " " << "left(hex)" << " "
			<< "right(hex)" << " " << "round keys" << endl;
	for (int i = 0; i < 16; i++) {
		// Expansion D-box
...
string decrypt(string pt, vector<string> rkb, vector<string> rk)
{
    pt = hex2bin(pt);
	int initial_perm[64] = { 58, 50, 42, 34, 26, 18, 10, 2,
							60, 52, 44, 36, 28, 20, 12, 4,
...
int main()
{
        ...
        printf("DES Implementation DEMO \n");
        ...
        case 1:
            ...
            cout << "AB" << " " << "to" << " " <<  hex2bin("AB") << endl;
            break;

        case 2:
            cout << "Binary" << " " << "to" << " " <<  "hexadecimal" << endl;
            cout << "10101011" << " " << "to" << " " <<  bin2hex("10101011") << endl;
            break;

        case 3:

            cout << "xor operation" << endl;
            cout << "101010" << endl << "010101" << endl << xor_("101010", "010101") << endl;
           break;
        ...
        cout << "Parity bit drop table" << endl;
        for (int i = 0; i < 56; i++)
        {
            if ( i>0 &&  i%10 == 0 )
                cout << '\n';
        ...
        cout << "Key (64 bit): " << key << endl;
        key = permute(key, keyp, 56); // key without parity
        cout << "Key (56 bit): " << key << endl;
        ...
        cout << "Key- Compression Table table" << endl;
        for (int i = 0; i < 56; i++)
        {
            if ( i>0 &&  i%10 == 0 )
                cout << '\n';
        ...
        string text = decrypt(cipher, rkb, rk);
